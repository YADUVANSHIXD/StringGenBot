...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@YaduvanshiXbotz"))
        else:
            ...
            await client.join_chat("YaduvanshiXbotz")
    except KeyError:
        pass
    try:
